    ...
    <div className="mock-card-graphic" style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          lineHeight: 1,
          minWidth: '60px',
        }}>8<span style={{ fontSize: '1.2rem', color: '#333' }}>/10</span></div>
        <div>
        ...
        <div style={{ display: 'flex', gap: '8px', marginTop: '12px' }}>
          {[8, 7, null, null, null].map((score, i) => (
            <div key={i} style={{
              ...
              height: '32px',
              borderRadius: '6px',
              background: score ? 'rgba(255,107,53,0.12)' : '#0C0C0C',
              border: `1px solid ${score ? 'rgba(255,107,53,0.25)' : '#1A1A1A'}`,
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              fontSize: '0.72rem',
              fontWeight: 700,
              color: score ? '#FF6B35' : '#2A2A2A',
            }}>{score || '—'}</div>
          ))}
        </div>
      </div>
      ...
      <section className="hero" style={{ textAlign: 'left', alignItems: 'flex-start', position: 'relative', zIndex: 1 }}>
        ...
        <div className="hero-metrics">
          <div className="metric">
            <span className="metric-val">5<span>x</span></span>
            <span className="metric-label">Questions per role</span>
          </div>
          <div className="metric">
            <span className="metric-val">&lt;10<span>s</span></span>
            <span className="metric-label">To get feedback</span>
          </div>
          <div className="metric">
            <span className="metric-val">AI</span>
            <span className="metric-label">Scores every answer</span>
          </div>
          <div className="metric">
            <span className="metric-val">∞</span>
            <span className="metric-label">Sessions, free</span>
          </div>
        </div>
      ...
      <section className="features" id="features" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="features-grid">
          <div className="feature-card">
            <span className="feature-icon">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                <circle cx="11" cy="11" r="10" stroke="#FF6B35" strokeWidth="1.5"/>
                <circle cx="11" cy="11" r="4" fill="#FF6B35" opacity="0.2"/>
                <circle cx="11" cy="11" r="1.5" fill="#FF6B35"/>
                <line x1="11" y1="1" x2="11" y2="5" stroke="#FF6B35" strokeWidth="1.5" strokeLinecap="round"/>
                <line x1="11" y1="17" x2="11" y2="21" stroke="#FF6B35" strokeWidth="1.5" strokeLinecap="round"/>
                <line x1="1" y1="11" x2="5" y2="11" stroke="#FF6B35" strokeWidth="1.5" strokeLinecap="round"/>
                <line x1="17" y1="11" x2="21" y2="11" stroke="#FF6B35" strokeWidth="1.5" strokeLinecap="round"/>
              </svg>
            </span>
          ...
          <div className="feature-card">
            <span className="feature-icon">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                <path d="M11 2L13.5 8.5H20.5L14.5 12.5L17 19L11 15L5 19L7.5 12.5L1.5 8.5H8.5L11 2Z" stroke="#FF6B35" strokeWidth="1.5" strokeLinejoin="round"/>
              </svg>
            </span>
          ...
          <div className="feature-card">
            <span className="feature-icon">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                <rect x="2" y="14" width="4" height="7" rx="1" fill="#FF6B35" opacity="0.3" stroke="#FF6B35" strokeWidth="1.5"/>
                <rect x="9" y="9" width="4" height="12" rx="1" fill="#FF6B35" opacity="0.3" stroke="#FF6B35" strokeWidth="1.5"/>
                <rect x="16" y="4" width="4" height="17" rx="1" fill="#FF6B35" opacity="0.3" stroke="#FF6B35" strokeWidth="1.5"/>
              </svg>
            </span>
          ...
          <div className="feature-card">
            <span className="feature-icon">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                <rect x="2" y="2" width="8" height="8" rx="2" stroke="#FF6B35" strokeWidth="1.5"/>
                <rect x="12" y="2" width="8" height="8" rx="2" stroke="#FF6B35" strokeWidth="1.5" opacity="0.5"/>
                <rect x="2" y="12" width="8" height="8" rx="2" stroke="#FF6B35" strokeWidth="1.5" opacity="0.5"/>
                <rect x="12" y="12" width="8" height="8" rx="2" stroke="#FF6B35" strokeWidth="1.5" opacity="0.3"/>
              </svg>
            </span>
        ...
        <div className="steps">
          ...
          <div className="step-arrow">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M4 10H16M16 10L11 5M16 10L11 15" stroke="#333" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
          <div className="step">
